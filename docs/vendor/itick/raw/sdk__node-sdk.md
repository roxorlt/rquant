<!-- source: https://docs.itick.org/zh-cn/sdk/node-sdk.md -->
<!-- fetched: 2026-07-28 | locale: zh-cn | mode: md | slug: sdk/node-sdk -->

---
title: NodeJs SDK
description: iTick 官方 NodeJs SDK，提供基础、股票、指数、期货、基金、外汇、加密货币数据的 REST API 查询和 WebSocket 实时数据订阅功能。
keywords: NodeJs SDK, iTick 官方SDK, REST API, WebSocket
---

## NodeJs SDK 文档

Node.js 版本的 iTick API SDK，提供基础、股票、指数、期货、基金、外汇、加密货币数据的 REST API 查询和 WebSocket 实时数据订阅功能。用于访问 iTick API 的实时金融市场数据。
...
| `getKlines`    | `options`: `GetKlineOptions`<br>- `region`: `string` (市场编码)<br>- `codes`: `string[] \| string` (股票代码列表)<br>- `interval`: `KlineType` (K 线周期类型)<br>- `limit`: `number` (返回数据条数，最大 500)<br>- `et`?: `string \| number` (可选，结束时间戳) | `Promise<APIResponse<KlineDataMap>>` | 获取多个股票 K 线数据               | [iTick 股票批量 K 线](https://docs.itick.org/rest-api/stocks/stock-klines) |
...
| `getKlines`    | `options`: `GetKlineOptions`<br>- `region`: `string` (市场编码)<br>- `codes`: `string[] \| string` (标的代码列表)<br>- `interval`: `KlineType` (K 线周期类型)<br>- `limit`: `number` (返回数据条数，最大 500)<br>- `et`?: `string \| number` (可选，结束时间戳) | `Promise<APIResponse<KlineDataMap>>` | 获取多个加密货币 K 线数据           | [iTick 加密货币批量 K 线](https://docs.itick.org/rest-api/crypto/crypto-klines) |
...
| `getKlines`    | `options`: `GetKlineOptions`<br>- `region`: `string` (市场编码)<br>- `codes`: `string[] \| string` (标的代码列表)<br>- `interval`: `KlineType` (K 线周期类型)<br>- `limit`: `number` (返回数据条数，最大 500)<br>- `et`?: `string \| number` (可选，结束时间戳) | `Promise<APIResponse<KlineDataMap>>` | 获取多个外汇对 K 线数据             | [iTick 外汇批量 K 线](https://docs.itick.org/rest-api/forex/forex-klines) |
...
| `getKlines`    | `options`: `GetKlineOptions`<br>- `region`: `string` (市场编码)<br>- `codes`: `string[] \| string` (标的代码列表)<br>- `interval`: `KlineType` (K 线周期类型)<br>- `limit`: `number` (返回数据条数，最大 500)<br>- `et`?: `string \| number` (可选，结束时间戳) | `Promise<APIResponse<KlineDataMap>>` | 获取多个指数 K 线数据               | [iTick 指数批量 K 线](https://docs.itick.org/rest-api/indices/indices-klines) |
...
| `getKlines`    | `options`: `GetKlineOptions`<br>- `region`: `string` (市场编码)<br>- `codes`: `string[] \| string` (标的代码列表)<br>- `interval`: `KlineType` (K 线周期类型)<br>- `limit`: `number` (返回数据条数，最大 500)<br>- `et`?: `string \| number` (可选，结束时间戳) | `Promise<APIResponse<KlineDataMap>>` | 获取多个期货合约 K 线数据           | [iTick 期货批量 K 线](https://docs.itick.org/rest-api/future/future-klines) |
...
| `getKlines`    | `options`: `GetKlineOptions`<br>- `region`: `string` (市场编码)<br>- `codes`: `string[] \| string` (标的代码列表)<br>- `interval`: `KlineType` (K 线周期类型)<br>- `limit`: `number` (返回数据条数，最大 500)<br>- `et`?: `string \| number` (可选，结束时间戳) | `Promise<APIResponse<KlineDataMap>>` | 获取多个基金 K 线数据               | [iTick 基金批量 K 线](https://docs.itick.org/rest-api/fund/fund-klines) |
